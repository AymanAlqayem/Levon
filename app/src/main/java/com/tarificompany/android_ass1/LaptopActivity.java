...
public class LaptopActivity extends AppCompatActivity {
    ...
    public void loadItems() {
        ...
        // Load items from ItemManager and filter for Laptops.
        ArrayList<Item> itemArrayList = new ArrayList<>();
        for (Item item : ItemManager.getAllItems(this)) {
            if (item.getId() >= 176 && item.getId() <= 185) {
        ...
        itemsList.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(LaptopActivity.this, ItemDetailActivity.class);
