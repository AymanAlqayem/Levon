...
public class fitnessActivity extends AppCompatActivity {
    ...
    public void loadItems() {
        ...
        // Load items from ItemManager and filter for fitness.
        ArrayList<Item> itemArrayList = new ArrayList<>();
        for (Item item : ItemManager.getAllItems(this)) {
            if (item.getId() >= 52 && item.getId() <= 70) {
        ...
        itemsList.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(fitnessActivity.this, ItemDetailActivity.class);
