...
public class PhoneCasesActivity extends AppCompatActivity {
    ...
    public void loadItems() {
        ...
        title.setText("Phone cases");

        // Load items from ItemManager and filter for Phone cases.
        ArrayList<Item> itemArrayList = new ArrayList<>();
        for (Item item : ItemManager.getAllItems(this)) {
            if (item.getId() >= 216 && item.getId() <= 230) {
        ...
        itemsList.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(PhoneCasesActivity.this, ItemDetailActivity.class);
